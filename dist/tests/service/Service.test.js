...
var HiveWorker = require('../../workers/HiveWorker');
...
describe('Service', function () {
    ...
    it("should have a 'use' method that accepts an IWorker and manages it's dependencies when started", function (done) {
    ...
    it("should have a 'list-workers' listener that provides a list of worker names that are running", function (done) {
        new Service('service-name')
            ...
            iw.service.ask('list-workers', function (e, workers) {
                expect(e).to.be.null;
    ...
    it("should provide a 'who' listener that provides it's whoService object", function (done) {
        new Service('service-name')
            .info('ready', function (iw) {
            iw.service.ask('who', function (e, whoService) {
                expect(e).to.be.null;
