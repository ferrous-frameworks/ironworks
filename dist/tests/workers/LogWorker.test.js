...
describe('LogWorker', function () {
    ...
    it("should not log emitted properties on events annotated with the 'log.properties[].level' if it's higher than the 'level' option", function (done) {
        new Service('service-name')
            .use(new LogWorker({
            stdout: function (str) {
                var obj = JSON.parse(str);
    ...
    it("should not log emitted nested properties on events annotated with the 'log.properties[].level' if it's higher than the 'level' option", function (done) {
        new Service('service-name')
            .use(new LogWorker({
            stdout: function (str) {
                var obj = JSON.parse(str);
    ...
    it("should replace the logged property value with '*****' on events annotated with the 'log.properties[].secure'", function (done) {
        new Service('service-name')
            .use(new LogWorker({
            stdout: function (str) {
                var obj = JSON.parse(str);
    ...
    it("should collapse the logged array value on events annotated with the 'log.properties[].arrayLengthOnly'", function (done) {
        new Service('service-name')
            .use(new LogWorker({
            stdout: function (str) {
                var obj = JSON.parse(str);
...
//# sourceMappingURL=LogWorker.test.js.map