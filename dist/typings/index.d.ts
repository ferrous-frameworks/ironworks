...
/// <reference path="./hapi/index.d.ts" />
/// <reference path="./joi/index.d.ts" />
/// <reference path="./json-stringify-safe/index.d.ts" />
/// <reference path="./jsonwebtoken/index.d.ts" />
/// <reference path="./socket.io-client/index.d.ts" />
/// <reference path="./socket.io/index.d.ts" />
/// <reference path="./socketio-auth/index.d.ts" />
